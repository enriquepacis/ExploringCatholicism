...
* Objections
:PROPERTIES:
:CUSTOM_ID: objections
:END:

Here, we discuss some objections raised by various groups about Catholicism.
** The Catholic Church Teaches a False Gospel
:PROPERTIES:
:CUSTOM_ID: false-gospel
:END:

Does the Gospel teach that individuals are saved by *grace alone*? Dr. David
Anders answers a question about what the Gospel is.

#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/gzZxBXXtNzc?si=CkrSLeSE2MkPuJks&amp;start=1217" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Dr. David Anders also gives a great discussion on /sola fide/, /sola scriptura/,
and how the Church historically interpreted the passages that give rise to /sola
fide/. See the first 12 minutes of this video from 2026.01.21:
#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/L5riR6l0NoA?si=Jx6xfNc7w_Di-li6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
:PROPERTIES:
:CUSTOM_ID: saints-intercession
:END:
Sam Shamoun discusses the intercession of the saints.
#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/ycyTnsfmzw8?si=LWp-3Yd-KtMTdxXr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Sam Shamoun gives a /beautiful/ Bible study on the intercession of the saints.
#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/6N3U0YovqtI?si=EsghgfAXUGocabIo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Sam Shamoun answers questions about prayers to Mary, the saints, and the rosary.
#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/IQQeHs-BDuI?si=1ft1AWHfsBTxSHoy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
*** Veneration of Mary and the Saints
:PROPERTIES:
:CUSTOM_ID: saints-veneration
:END:
...
2. The veneration of Mary. The Church's great regard for Mary goes back to the
   ...
   she is graced completely and enduringly. St. Justin Martyr (lived around 100-155
...
#+begin_note
#+html: <a id="doctrinal-development"><b>What Catholic Teachings and Practices Can Change Over Time?</b></a>
#+html: <details>
#+html: <summary>Read more ...</summary>
...
practices into five categories, which we abbreviate as /Deposit/, /Dogma/,
...
#+html: <a id="doctrinal-development"><b>Reversals in Church Doctrine?</b></a>
If the Catholic Church has reversed her teachings on various doctrines, how can she be trusted?

Obviously, the Catholic Church doesn't see herself as having reversed doctrines. Dr. Anders poses a larger question of interpretation.
#+html: <details><summary>See the video ...</summary>
#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/bdGUsf4aNPI?si=xRG2rePyZn3Zaorc&amp;start=3062" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
#+html: </details>
#+end_note

** The Catholic Church Creates Unnecessary Dogmas

A friend of mine recently raised the following objection: "The Catholic Church
dogmatizes things that are unnecessary for salvation, such as the Perpetual
Virginity of Mary. This is not a dogma for the Orthodox Church." My friend did
not appear to have any dispute with the doctrine itself, but rather that it was
elevated to a dogma binding upon all Catholics, even though it is unnecessary
for salvation. His conclusion is that it is better to be Orthodox than a
Catholic for this reason.

This prompted me to look into the Perpetual Virginity of Mary more closely, and
it rases many questions. The first question is, *When was the Perpetual
Virginity dogmatized, and why?*

The dogma of Mary’s perpetual virginity (that she was a virgin before, during,
and after the birth of Christ) was formally declared at the Second Council of
Constantinople in 553 AD. While upheld by early Church Fathers, this council
officially confirmed her title as /aeiparthenos/ or
"ever-virgin". Interestingly, Second Council of Constantionople is the Fifth of
The Seven Ecumenical Councils, which are considered infallible and normative for
Orthodox doctrine. Convoked by Emperor Justinian I, it confirmed the teachings
of previous councils, specifically addressing Christological issues. As an
Ecumenical Council, its decisions are considered inspired by the Holy Spirit and
binding upon the entire Church in terms of dogma. Although it did not issue new
disciplinary canons (unlike the Third Council of Constantinople), its dogmatic
decrees are absolutely foundational to Orthodox theology. Thus, while the term
/Perpetual Virginity/ was not used in the Second Council of Constantinople, the
title /Ever Virgin/ was, and this is essentially equivalent to the Perpetual
Virginity.

In the Lateran Council of 649, Pope Martin I formally defined the "threefold"
nature of her virginity—/ante partum, in partu, and post partum/—meaning she
remained a virgin before, during, and after the birth of Jesus. While the
Lateran Council of 649 is not regarded by the Orthodox as one of the Seven
Ecumenical Councils, this is a clarification and development of doctrine that is
completely consistent with what was revealed and defined at the Second Council
of Constantinople.

Now we may turn to why 
...
:properties:
:custom_id: papal-origins
:end:

Dr. David Anders discusses the Biblical and Traditional origins of the Papacy.

#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/4gtbMuZT8nM?si=zTfJRibX6GAgzfKh" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/gzZxBXXtNzc?si=EFHULnFkhIXZYeuz&amp;start=327" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

*** TODO The Sale of Indulgences Proves that Papal Infallibility is False

The argument here might be as follows:
1. The Catholic church claims that the pope is infallible when teaching on faith
   or morals. 
2. Pope Leo X authorized the sale of indulgences, an immoral practice.
3. Thus, Pope Leo X taught by his actions immorality.
4. The doctrine of papal infallibility is false.

To evaluate this argumet, we must first understand indulgences. To understand
indulgences, we must first understand the Catholic view of sin and forgiveness.

The Catholic Church states that sin has a double consequence. That is, sin
merits *two punishments*:
1. The *eternal punishment* for sin. As stated in paragraph 1472 of the
   Catechism of the Catholic Church (CCC) ([[https://www.vatican.va/content/catechism/en/part_two/section_two/chapter_two/article_4/x_indulgences.html][link]]),
   #+begin_quote
   Grave sin deprives us of communion with God and therefore makes us incapable
   of eternal life, the privation of which is called the "eternal punishment" of
   sin.
   #+end_quote
2. The *temporal punishment* for sin. CCC 1472 goes on to say:
   #+begin_quote
   On the other hand every sin, even venial,
   ...
   It bears clarifying that an /attachment/ is defined as a disordered or
   unhealthy love for a good gift that God has given us (friends, family,
   career, wealth, etc.). Attachments can become a form of idolatry, and they
   can cloud our judgment for fear of losing the good gift God has given
   us. Attachments can lead to sin.
   ...
   mercy and charity, as well as by prayer and the various practices of penance,
   to put off completely the "old man" and to put on the "new man."
   #+end_quote
   That is, forgiveness of sin restores communion with God (removes the eternal
   punishment in the case of mortal sins), but it doesn't fix the temporal
   effects of sin.

   A great example of this is when David committed adultery with
   Bathseba. Eventually, David was forgiven by God, but God allowed temporal
   effects play out in David's life: the child conceived in sin dide, and this
   episode led to division in David's family, culminating in rebellion and civil
   war. In respondinng to these temporal effects well, David began detaching
   himself from his own interior inclination to lust. He never committed
   adultery again.
...
#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/gzZxBXXtNzc?si=2XKRzLIa3GTQe6uC&amp;start=671" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

** I Disagree with the Catholic Rules about Divorce and Remarriage

Dr. David Anders fields a question about the Catholic regulations on divorce and
remarriage. Does Jesus allow for divorce and remarriage in the case of
unchastity?

Dr. David Anders says the Scriptures prohibit divorce and remarriage, and
St. Paul recognizes the principle of annulment.

#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/gzZxBXXtNzc?si=CWgNj0jJ5FzWZI16&amp;start=825" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
This is to say I don't need the Cahtolic Church--or any other church, for that
matter.

#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/ueFq_Yb6Vnk?si=lLdCyHKgEDMRHRzl&amp;start=840" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

** /Sola fide/ and Clarifies Existing Christian Though on Soteriology
:CUSTOM_ID: objections-sola-fide-clarifies

This is an interesting discussion that arose between myself and my
colleagues. We work at a Christian university with roots in the Baptist General
Convention of Texas. We are charged with preserving the Christian character of
the university. Part of our charge is to hire only Christians. In our hiring
discussions, belief in the doctrine of /sola scriptura/ is used as a litmus test
for the property of Christianness in a faculty candidate. The line of thinking
is something like this:
1. The Christian Gospel is that man is saved by faith alone by grace alone (we
   can summarize this using the Latin phrase /sola fide/, meaning "by faith
   alone", which many Evangelical Protestants interpret as salvation by grace at
   the exclusion of works.
2. If a candidate does not adhere to the dogma of /sola fide/, he or she does
   not believe in the true Christian Gospel, and so is not a true Christian.
3. The conclusion is that a candidate who does not hold to /sola fide/ cannot be
   hired because they do not meet the criterion of being a Christian.

As a Catholic, I object to this line of reasoning
   



#+begin_note
*Would St. Augustine be a Calvinist if he were alive today?*

#+html: <details>
#+html: <summary>Read more ...</summary>

#+html: <iframe width="560" height="315" src="https://www.youtube.com/embed/S5-Lq6jzsNA?si=1zCkWbaMEbYP_B7p&amp;start=207" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
