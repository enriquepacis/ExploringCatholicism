...
to Him in an encounter that is more intimate than any act that spouses can perform.
#+html: </details>
#+end_info
...
#+attr_html: :width 640px
#+caption: This rendition of the Last Supper is by Juan de Juanes.
...
#+attr_html: :width 640px
#+caption: An icon of the Twelve Apostles.
...
#+caption: St. Justyn Martyr (100-165 AD) is one of the earliest Christian writers. He was born within 1-2 decades after the death of John the Evangelist.
