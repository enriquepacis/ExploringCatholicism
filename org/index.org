...
#+begin_src zsh :results output
  ...
  git commit -m "Corrects some grammar on the into page."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 4c88fae] Adds a Sam Shamoun video on prayers to the saints/Mary.
:  3 files changed, 1358 insertions(+), 1346 deletions(-)
: Already up to date.
