...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a link to the USCCB abortion infographic"
  git pull
  git push
#+end_src

#+RESULTS:
: [main ede2dc5] Updates the index and supporting org docs
:  3 files changed, 582 insertions(+), 579 deletions(-)
: Already up to date.
