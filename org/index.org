...
#+begin_src zsh :results output
  ...
  git commit -m "Adds some Romans 11 as refutation of eternal security."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 06170b5] Adds some Romans 11 as refutation of eternal security.
:  5 files changed, 1099 insertions(+), 804 deletions(-)
: Already up to date.
