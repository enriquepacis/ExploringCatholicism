...
#+begin_src zsh :results output
  ...
  git commit -m "Adds some videos by Dr. David anders about raising and evangelizing children."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 1bdaf40] Adds books to the notes on spritual theology.
:  2 files changed, 1472 insertions(+), 1456 deletions(-)
: Already up to date.
