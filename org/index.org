...
#+begin_src zsh :results output
  ...
  git commit -m "Adds the Mary-Woman-Eve connection."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 717e34a] Adds a video by mother angelica on fallacies in modern culture.
:  4 files changed, 1369 insertions(+), 1345 deletions(-)
: Already up to date.
