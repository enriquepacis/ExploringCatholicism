...
#+begin_src zsh :results output
  ...
  git commit -m "Adds testimonies of Protestant converts to Catholicism."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 160e4ee] Adds discussion on Romans 5:9-10.
:  4 files changed, 744 insertions(+), 610 deletions(-)
: Already up to date.
