...
#+begin_src zsh :results output
  ...
  git commit -m "Updates the links pertaining to Mother Angelica."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 24ee542] Adds links/info about Mother Angelica.
:  4 files changed, 1441 insertions(+), 1334 deletions(-)
: Already up to date.
