...
#+begin_src zsh :results output
  ...
  git commit -m "Cleans up information about induction, deduction, and faith."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 04074a2] Adds information about Big Tech and Ireland
:  4 files changed, 578 insertions(+), 570 deletions(-)
: Already up to date.
