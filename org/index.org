...
#+begin_src zsh :results output
  ...
  git commit -m "Adds some cross-references and a GOD-LOVES-YOU discussion."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 4e45f73] Adds some cross-references.
:  5 files changed, 600 insertions(+), 583 deletions(-)
: Already up to date.
