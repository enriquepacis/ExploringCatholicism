...
#+begin_src zsh :results output
  ...
  git commit -m "Adds some devotional readings from Office fo the Readings."
  git pull
  git push
#+end_src

#+RESULTS:
: [main bf4c3d5] Adds some devotional readings from Office fo the Readings.
:  5 files changed, 2026 insertions(+), 1392 deletions(-)
: Already up to date.
