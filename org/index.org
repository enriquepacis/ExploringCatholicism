...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a link to the an Ethics and Medics paper"
  git pull
  git push
#+end_src

#+RESULTS:
: [main e13bf11] Adds a link to the USCCB abortion infographic
:  5 files changed, 644 insertions(+), 569 deletions(-)
: Already up to date.
