...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a a container name to the sola scriptura page."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 8dfe88d] Adds a quote from St. Ignatius' Epistle to the Romans.
:  4 files changed, 769 insertions(+), 721 deletions(-)
: Already up to date.
