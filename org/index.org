...
#+begin_src zsh :results output
  ...
  git commit -m "Adds some non-sola fide scriptures"
  git pull
  git push
#+end_src

#+RESULTS:
: [main 4c4fd64] Adds a link to a Mother Angelica video on the anima christi
:  3 files changed, 1324 insertions(+), 1310 deletions(-)
: Already up to date.
