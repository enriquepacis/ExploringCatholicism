...
#+begin_src zsh :results output
  ...
  git commit -m "Reorganizes the truth page"
  git pull
  git push
#+end_src

#+RESULTS:
: [main 2b2adb1] Adds some cross-references and a GOD-LOVES-YOU discussion.
:  4 files changed, 874 insertions(+), 616 deletions(-)
: Already up to date.
