...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a Mother Angelica episode (Silence in the Heart) really"
  git pull
  git push
#+end_src

#+RESULTS:
: [main ad9c7ce] Adds a Mother Angelica episode (Silence in the Heart)
:  4 files changed, 1513 insertions(+), 1359 deletions(-)
: Already up to date.
