...
#+begin_src zsh :results output
  ...
  git commit -m "Adds videos on venial and mortal sin."
  git pull
  git push
#+end_src

#+RESULTS:
: [main f2f4e6e] Adds a page on St. Mary.
:  5 files changed, 1768 insertions(+), 814 deletions(-)
:  create mode 100644 org/mary.org
: Already up to date.
