...
#+begin_src zsh :results output
  ...
  git commit -m "Adds discussion about being Christianity versus religion."
  git pull
  git push
#+end_src

#+RESULTS:
: [main e522786] Adds implicit evidence of the motherhood of mary.
:  4 files changed, 1376 insertions(+), 1342 deletions(-)
: Already up to date.
