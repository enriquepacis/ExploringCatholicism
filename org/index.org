...
#+begin_src zsh :results output
  ...
  git commit -m "Adds links to Christ is the Answer episodes."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 456a838] Adds the perpetual adoration finder
:  8 files changed, 1723 insertions(+), 1302 deletions(-)
:  create mode 100644 org/rosary-scriptural-joyful.org
: Already up to date.
