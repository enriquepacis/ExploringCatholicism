...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a link to the doctrinal development note"
  git pull
  git push
#+end_src

#+RESULTS:
: [main 95ad5cd] Adds a video on the origin of the papacy.
:  4 files changed, 1342 insertions(+), 1309 deletions(-)
: Already up to date.
