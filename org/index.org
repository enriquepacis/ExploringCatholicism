...
#+begin_src zsh :results output
  ...
  git commit -m "Rearranges some content."
  git pull
  git push
#+end_src

#+RESULTS:
: [main b36aa0e] Adds a Mother Angelica episode (Silence in the Heart) really
:  3 files changed, 1413 insertions(+), 1353 deletions(-)
: Already up to date.
