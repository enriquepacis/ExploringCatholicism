...
#+begin_src zsh :results output
  ...
  git commit -m "Adds the Keith Nester testimony."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 95e9b66] Adds testimonies of Protestant converts to Catholicism.
:  4 files changed, 908 insertions(+), 605 deletions(-)
: Already up to date.
