...
#+begin_src zsh :results output
  ...
  git commit -m "Adds links/info about Mother Angelica."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 554b653] Adds links to Christ is the Answer episodes.
:  6 files changed, 1683 insertions(+), 1308 deletions(-)
: Already up to date.
