...
#+begin_src zsh :results output
  ...
  git commit -m "Adds discussion of the motherhood and queenship of Mary."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 0a8c3bc] Adds discussion of the motherhood and queenship of Mary.
:  4 files changed, 1687 insertions(+), 1312 deletions(-)
: Already up to date.
