...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a short form for the sciptural nativity mystery"
  git pull
  git push
#+end_src

#+RESULTS:
: [main 4185cf7] Adds rosary discussion
:  5 files changed, 4160 insertions(+), 1060 deletions(-)
:  create mode 100644 org/prayer.org
:  create mode 100644 org/rosary.org
: Already up to date.
