...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a video about mental prayer."
  git pull
  git push
#+end_src

#+RESULTS:
: [main a622338] Adds a comment about a video clip from Patrick Madrid; a Dr. Broussard video on eternal security.
:  5 files changed, 902 insertions(+), 793 deletions(-)
: Already up to date.
