...
#+begin_src zsh :results output
  ...
  git commit -m "Cleans up discussion about double effect"
  git pull
  git push
#+end_src

#+RESULTS:
: [main 9a9b6bb] Cleans up information about induction, deduction, and faith.
:  4 files changed, 598 insertions(+), 598 deletions(-)
: Already up to date.
