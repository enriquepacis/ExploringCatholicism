...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a quote from St. Ignatius' Epistle to the Romans."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 527b7c8] Adds a video about Biblical self-interpretation.
:  4 files changed, 743 insertions(+), 715 deletions(-)
: Already up to date.
