...
#+begin_src zsh :results output
  ...
  git commit -m "Adds some links to Objections subsections"
  git pull
  git push
#+end_src

#+RESULTS:
: [main 30982c9] Adds some links to Objections subsections
:  4 files changed, 1377 insertions(+), 1368 deletions(-)
: Already up to date.
