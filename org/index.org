...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a portraint of St. Justin Martyr as well as greek works."
  git pull
  git push
#+end_src

#+RESULTS:
: [main 3e448c6] Adds a linkable label for the Eucharist content.
:  4 files changed, 693 insertions(+), 671 deletions(-)
: Already up to date.
