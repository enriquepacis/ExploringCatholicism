...
#+begin_src zsh :results output
  ...
  git commit -m "Adds a paragraph break."
  git pull
  git push
#+end_src

#+RESULTS:
: [main d798384] Adds a portraint of St. Justin Martyr as well as greek works.
:  4 files changed, 933 insertions(+), 684 deletions(-)
: Already up to date.
