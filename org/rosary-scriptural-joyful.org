#+TITLE: Scriptural Rosary – The Joyful Mysteries
#+AUTHOR: 
#+DATE: 
...
** Hail Mary (for faith, hope, and charity)
Next, we say pray the /Hail Mary/ *three times*, once for each of the three
theological virtures of *faith*, *hope*, and *love* (or
*charity*). *Faith* allows us to know God; *hope* allows us to trust
God; and *charity* allows us to *obey* God:
...
(Pray three times for Faith, Hope, and Charity.)
...
- Pray ten *Hail Marys* with bolded response.  
- Conclude with the *Glory Be* and *Fatima Prayer.*
...
(Then proceed as with the first mystery with prayer intentions and the
